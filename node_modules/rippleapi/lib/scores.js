...
module.exports.getUserRecent = async (user, mode) => {
    try {
        let url = (typeof user == 'number') ? `https://ripple.moe/api/v1/users/scores/recent?id=${user}` : `https://ripple.moe/api/v1/users/scores/recent?name=${user}`;
        url = setMode(mode, url);
