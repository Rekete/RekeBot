...
module.exports.getUserById = async (userId) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users?id=${userId}`;
...
module.exports.getUserByName = async (username) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users?name=${username}`;
        const response = await axios.get(url);
        return response.data;
    } catch (e) {
        throw new Error(e);
...
module.exports.getFullUserById = async (id) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users/full?id=${id}`;
        const response = await axios.get(url);
        return response.data;
    } catch (e) {
        throw new Error(e);
...
module.exports.getFullUserByName = async (username) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users/full?name=${username}`;
        const response = await axios.get(url);
        return response.data;
    } catch (e) {
        throw new Error(e);
...
module.exports.getUserByNameAka = async (nameAka, page) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users?name_aka=${nameAka}&p=${page}`;
        const response = await axios.get(url);
        return response.data;
    } catch (e) {
        throw new Error(e);
...
module.exports.getUsersByCountry = async (country, page) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users?country=${country}&p=${page}`;
        const response = await axios.get(url);
        return response.data;
    } catch (e) {
        throw new Error(e);
...
module.exports.getUsersByPrivilegeGroup = async (privilegeGroup, page) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users?privilege_group=${privilegeGroup}&p=${page}`;
        const response = await axios.get(url);
        return response.data;
    } catch (e) {
        throw new Error(e);
...
module.exports.getUsersById = async (userIds) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users?`;
...
module.exports.getIdOfUser = async (username) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users/whatid?name=${username}`;
        const response = await axios.get(url);
        return response.data;
    } catch (e) {
        throw new Error(e);
...
module.exports.getUserpageById = async (id) => {
    try {
        ...
        let url = `https://ripple.moe/api/v1/users/userpage?id=${id}`;
        const response = await axios.get(url);
        return response.data;
    } catch (e) {
        throw new Error(e);
...
//         let url = `https://ripple.moe/api/v1/users/userpage?name=${username}`;
//         const response = await axios.get(url);
//         return response.data;
//     } catch (e) {
//         throw new Error(e);
...
module.exports.lookupUser = async (partOfUsername) => {
    try {
        if (!partOfUsername) throw new Error('A partOfUsername must be provided.');
        if (typeof partOfUsername != 'string') throw new Error('The partOfUsername provided must be a string.');

        let url = `https://ripple.moe/api/v1/users/lookup?name=${partOfUsername}`;
        const response = await axios.get(url);
        return response.data;
    } catch (e) {
        throw new Error(e);
